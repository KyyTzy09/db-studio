				...
				<div class="flex items-center gap-3">
					...
					<div class="flex items-center rounded-lg border border-slate-700 bg-slate-900 text-[11px]">
						<button
							...
							class="px-2 py-0.5 text-slate-300 hover:text-white hover:bg-slate-800 transition rounded-l-lg border-r border-slate-700 font-mono cursor-pointer"
						>
							CSV ⬇
						</button>
						<button
							onclick={handleExportJSON}
							class="px-2 py-0.5 text-slate-300 hover:text-white hover:bg-slate-800 transition rounded-r-lg font-mono cursor-pointer"
						>
							JSON ⬇
						</button>
					</div>
